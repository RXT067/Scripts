...
// u* == unsigned == No negative value
// i* == regular
// *num == Number of bits they take in memory
Floats: f32, f64
Boolean (bool)
Characters (char)
// char == one character
...
pub fn run () {
    ...
    let a1 = 'a';
    // Using single quotes is required for char
