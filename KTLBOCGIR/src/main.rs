/// NAME     : Krey's Todo List Based On Coding Garden In Rust
/// AUTHOR   : github.com/kreyren
/// LICENSE  : GNUv2 (https://www.gnu.org/licenses/old-licenses/gpl-2.0.cs.html)
/// ABSTRACT : Do whatever guy in https://www.youtube.com/watch?v=IhvzGzoq4mc does and then make it better
