...
if [ -e "/lib/bash/kreypi.bash" ]; then
	source "/lib/bash/kreypi.bash" && ([ -n "$debug" ] && printf "DEBUG: Kreypi in '/lib/bash/kreypi.bash' has been successfully sourced\n") || printf "FATAL: Unable to source '/lib/bash/kreypi.bash'\n" ; exit 1
